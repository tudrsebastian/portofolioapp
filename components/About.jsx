      ...
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          ...
          <p className="py-2 text-gray-600">
            ...
            applications using Javascript,React,TailwindCSS and NextJS, I am a
          ...
          <p className="py-2 text-gray-600">
            I started web developement in 2021 learning by myself the basics of
            programming after 3 months I started a React course at ’The Informal
            School Of IT’ . I have experience working with diverse technologies.
            In my spare time I work on my portofolio apps and looking forward to
            start a Tech YouTube channnel.
          </p>
          <Link href="/#projects">
